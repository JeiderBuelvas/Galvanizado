...
<div class="contendor_kn">
  <div class="panel panel-default">
    <div class="panel-heading">
       <label><h2><b>REGISTRAR PEDIDO</b></h2></label>
    </div>
    <div class="panel-body">
        ...
        <form method="POST" id="create-form-documento">
          ...
          <div class="form-group">
            ...
            <div class="col-md-6">
              <label>Estado</label>
              <input type="text" id="txtestado" value="RECIBIDO" readonly style="color: rgb(25,25,51); background-color: rgb(255,255,255);solid 5px;color:#9B0000; text-align:center;font-weight: bold;" class="form-control"><br>
            </div>
          </div>
          <div class="form-group">
            <div class="col-md-6">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-12">
              ...
              <div class="form-group container-controllers"> <br>
                <label>Seleccionar Documentos (max. 4 archivos):</label>
                <div class="add-another-file row">
                  <!-- <div class="col">
                    <span>
                      (<span class="count-files-toadd">1</span>) Archivos
                    </span>
                  </div>
                  <div class="col">
                    <button class="btn" type="increment">+</button>
                  </div>
                  <div class="col">
                    <button class="btn" type="decrement">-</button>
                  </div>
                </div> -->
              </div>

              <div class="form-group container-files">
                ...
                <div class="input-group col-sm-12" style="width: 94%">
                  <input  type="text" class="form-control file-upload-info" disabled placeholder="Seleccionar Documentos">
          ...
          <div class="form-group">
            <div class="col-md-12" style="text-align: center;"><br>
              <br><button class="btn btn-success" onclick="Registrar_documento_post()" id="btnRegistrar"><strong> Registrar Pedido</strong></button><br><br>
            </div>
                  ...
                  <div class="nav-tabs-custom">
                    ...
                    <div class="tab-content" style="width: 100%">
                      <div class="tab-pane active" id="tab_1-1"><BR><BR>
                        <label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;DNI o NIT del cliente remitente:</label>
                        <br>
                        <div class="col-md-12"> 
                          <div class=" input-group">
                            <input type="text" class="form-control" placeholder="Ingresar dni o nit del cliente remitente a buscar" id="txtbuscar_dniremitente" onkeypress="">
