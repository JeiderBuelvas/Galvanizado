...
<div class="contendor_kn">
  <div class="panel panel-default">
    <div class="panel-heading">
      <h2><b>TIPO DE SEDES REGISTRADAS</b></h2>            
    </div>
    <div class="panel-body">
      <br>
      <div class="col-md-10"> 
        <div class=" input-group">
          <input type="text" class="form-control" placeholder="Ingresar nombre de la sede a buscar" id="txtbuscar_tipodocumento"  onkeypress="return soloLetras(event)"  >
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
         <div class="modal-header">
           ...
           <h4 class="modal-title" id="myModalLabel"><b>Editar Tipo de Sede</b></h4>
         </div>
