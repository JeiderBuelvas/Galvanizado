...
<div class="contendor_kn">
	<div class="panel panel-default">
		...
		<div class="panel-body">
            ...
            <div class="col-md-12">
                <label>Nombre</label>
                <input type="text" id="txttipodocumento_modal" placeholder="Ingrese el nombre o descripción de la Sede" onkeypress="return soloLetras(event)" style="background-color: #FFFFFF" class="form-control"><br>
            </div>
            <div class="col-md-12">
            ...
            <div class="col-md-12 col-lg-12 col-xs-12" style="text-align:center;" >
                <br><br>
                <button class="btn btn-success" onClick="Registrar_TipoDocumento()"><i class="fa fa-floppy-o"></i>&nbsp;<b>Rgistrar Sede</b></button>
            </div>
            <br>           			
        </div>
        <br>
