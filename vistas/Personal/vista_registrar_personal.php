    ...
    <div class="panel-body">     
          <div class="col-md-12 col-lg-12 col-xs-12"> 
            ...
            <div class="col-sm-4">
                ...
                <input type="text" class="form-control" id="txtdni" onkeypress="return soloNumeros(event)"   maxlength="20" style="background-color: #FFFFFF" placeholder="Ingrese Nº Documento Identidad">
                <br>
            </div>
            <div class="col-sm-4">
                <label >Sexo</label>
            ...
            <div class="col-sm-4">
                ...
                <select id="txtpuesto" class="form-control select2" name="txtGenero">
                  ...
                  <option value="Usuario">Coordinador</option> 
                  <option value="Usuario">Facturacion</option>
                  <option value="Usuario">Practicante</option> 
                </select>
                <br>
            </div><br> 
          </div>   
          <div class="col-md-12 col-lg-12 col-xs-12">   
            ...
            <div class="col-sm-4">
                <label >Usuario</label>
                <input type="email" class="form-control" id="txtusuario" maxlength="50" placeholder="Ingrese usuario del personal">
                <br>
            </div>
            <div class="col-md-4">
