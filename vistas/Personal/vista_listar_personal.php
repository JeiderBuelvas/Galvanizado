      	...
      	<div class="modal-body">
			<div class="panel-body">
	                    ...
	                    <div class="col-sm-6">
	                        ...
	                        <input type="text" class="form-control" onkeypress="return soloNumeros(event)" id="txttelefono_modal" placeholder="Ingrese nro telefóno" maxlength="10">
	                        <br>
	                    </div>        
	                    <div class="col-md-6">
	                        <label>Movil </label>
	                    ...
	                    <div class="col-md-4">
	                        ...
	                        <input type="text"  class="form-control"  onkeypress="return soloNumeros(event)" id="txtnrodocumento" style="width: 100%;" placeholder="Ingrese nro Documento" maxlength="20">
	                    </div>
	                    <div class="col-sm-4">
	                        <label>Email</label>
