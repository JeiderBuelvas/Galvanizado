...
<div class="contendor_kn">
  <div class="panel panel-default">
    <div class="panel-heading">
      <h2><b>REGISTRO DE CLIENTE O EMPRESA</b></h2>
    </div>
    <div class="panel-body">     
          <div class="col-md-12 col-lg-12 col-xs-12"> 
            <div class="col-sm-12">
                <label>Empresa o Cliente</label>
                <input id="txtnombre"  onkeypress=""  type="text" style="background-color: #FFFFFF"  placeholder="Ingrese Nombre de la persona o empresa" class="form-control" >
                <br>
            </div>
            <div class="col-sm-12">
            ...
            <div class="col-sm-4">
                <label >NIT</label>
                <input type="text" class="form-control" id="txtdni" onkeypress="return (event)"   maxlength="20" style="background-color: #FFFFFF" placeholder="Ingrese Nº De Identificacion">
                <br>
            </div>
            <br>
            <div class="col-md-4">
                <label>Tipo Persona o Empresa </label>
          ...
          <div class="col-md-12 col-lg-12 col-xs-12" style="text-align:center;">
            <div class="col-md-12">
              <br><button class="btn btn-success" onclick="revisar_dni_ciudadano()"><strong> Registrar Cliente</strong></button><br><br>
            </div>
          </div>
    </div>
  </div>
