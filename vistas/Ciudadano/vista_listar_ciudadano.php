    ...
    <div class="panel-body">
	    ...
	    <div class="col-md-10"> 
	        <div class=" input-group">
	          	<input type="text" class="form-control" placeholder="Ingrese el nombre de la empresa/Cliente" id="txtbuscar_ciudadano"  onkeypress=""  >
      	...
      	<div class="modal-body">
			<div class="panel-body">
	                    <div class="col-sm-12">
	                        ...
	                        <label>Empresa </label>
	                        <input type="text" class="form-control" onkeypress="" id="txtnombre_alimentos" placeholder="Ingrese Nombres" maxlength="">
	                        <br>
	                    </div>
	                    <div class="col-md-6">
	                        <label>Tipo Persona/Empresa </label>
	                    ...
	                    <div class="col-sm-6">
	                        ...
	                        <input type="text" class="form-control" onkeypress="return soloNumeros(event)" id="txttelefono_modal" placeholder="Ingrese nro telefóno" maxlength="7">
	                        <br>
	                    </div>        
	                    <div class="col-md-6">
	                        <label>Movil </label>
	                        <input type="text"class="form-control" id="txtmovil_modal"  onkeypress="return soloNumeros(event)" placeholder="Ingrese nro movil" maxlength="10">
	                            <br>
	                    </div> 
	                    <div class="col-md-6">
	                    ...
	                    <div class="col-md-4">
	                        <label>NIT</label>
	                        <input type="text"  class="form-control"  onkeypress="return (event)" id="txtnrodocumento" style="width: 100%;" placeholder="Ingrese NIT" maxlength="30">
	                    </div>
	                    <div class="col-sm-4">
	                        <label>Email</label>
	                        <input type="text"  class="form-control"  onkeypress="return soloLetras(event)" id="txtemail_modal" style="width: 100%;" placeholder="Ingrese correo empresarial" maxlength="13">
	                    </div>   
			</div>         
        </div> 
