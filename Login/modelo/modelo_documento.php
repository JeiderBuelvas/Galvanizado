<?php
	class Modelo_documento
	{
		...
		function modificar_documento($iddocumento,$asunto,$idtipodocu,$idarea,$idremitente,$estado,$idusuario,$opcion,$destinoImagen,$cont){
			$sql = "call PA_MODIFICARDOCUMENTOARCHIVO('$iddocumento','$asunto',$idtipodocu,$idarea,$idremitente,'$estado',$idusuario,'$opcion','$destinoImagen',$cont)";
			if($resultado = $this->conexion->conexion->query($sql)){
				return 1;
			}
			else{
